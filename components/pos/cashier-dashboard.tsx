...
export function CashierDashboard() {
  ...
  const handleSendReceiptEmail = async () => {
    if (!completedTransaction || !completedTransaction.customerEmail) {
      toast({ title: 'Error', description: 'No email address provided', variant: 'destructive' })
      return
    }

    setIsSendingReceipt(true)
    try {
      const lineItems = completedTransaction.lineItems || []
      ...
      const response = await fetch('/api/send-receipt', {
        ...
        body: JSON.stringify({
          ...
          customerEmail: completedTransaction.customerEmail,
          tableNumber: completedTransaction.table,
          serviceType: completedTransaction.serviceType,
      ...
      toast({
        title: 'Success',
        description: `Receipt sent to ${completedTransaction.customerEmail}`,
      })
    } catch (error) {
      console.error('Error sending receipt:', error)
      toast({
        title: 'Error',
        description: error instanceof Error ? error.message : 'Failed to send receipt email',
        variant: 'destructive',
      })
    } finally {
              ...
              >
                ...
                <div className="px-4 py-3">
                  ...
                  <div className="text-center border-b border-dashed border-gray-400 pb-3 mb-3">
                    ...
                    <p className="text-[10px] text-gray-500">Jl.Guru Saleh No.29, Cilandak, Jakarta Selatan</p>
                  ...
                  <div className="text-[11px] text-gray-700 mb-3 space-y-0.5">
                    ...
                    {completedTransaction.customerEmail && (
                      <div className="flex justify-between">
                        <span>Email</span>
                        <span className="text-[10px] truncate max-w-[150px]">{completedTransaction.customerEmail}</span>
                      </div>
                    )}
              ...
              <div className="mt-4 flex gap-3 px-2">
                ...
                {completedTransaction?.customerEmail && (
                  <Button 
                    ...
                    className="flex-1 bg-gradient-to-r from-blue-500 to-blue-700 text-white hover:from-blue-600 hover:to-blue-800"
