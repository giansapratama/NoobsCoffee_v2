...
export function LoginScreen() {
  ...
  const handleRegister = () => {
    // Only allow Cashier registration from public login page
    if (regRole !== 'cashier') {
      toast({
        title: 'Error',
        description: 'Admin users can only be created from the Admin Dashboard',
        variant: 'destructive',
      })
      return
    }
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4 pt-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">For Admin registration, please contact an existing administrator.</p>
            </div>
