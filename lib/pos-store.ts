...
const STORAGE_KEYS = {
  ...
  printerSettings: 'pos_printer_settings',
...
export function initializeStorage(): void {
  ...
  if (!localStorage.getItem(STORAGE_KEYS.printerSettings)) {
    saveToStorage(STORAGE_KEYS.printerSettings, defaultPrinterSettings)
  }
}
...
export function getPrinterSettings(): PrinterSettings {
  return getFromStorage(STORAGE_KEYS.printerSettings, defaultPrinterSettings)
}

export function updatePrinterSettings(settings: Partial<PrinterSettings>): PrinterSettings {
  const currentSettings = getPrinterSettings()
  const newSettings = { ...currentSettings, ...settings }
  saveToStorage(STORAGE_KEYS.printerSettings, newSettings)
  return newSettings
}
