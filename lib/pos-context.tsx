...
import {
  ...
  getPrinterSettings,
  updatePrinterSettings as updatePrinterSettingsStore,
  initializeStorage,
  hashPassword,
  formatCurrency,
} from './pos-store'
...
export function POSProvider({ children }: { children: React.ReactNode }) {
  ...
  const handleUpdatePrinterSettings = useCallback((newSettings: Partial<PrinterSettings>) => {
    const updated = updatePrinterSettingsStore(newSettings)
  ...
  const value: POSContextType = {
    ...
    printerSettings,
    updatePrinterSettings: handleUpdatePrinterSettings,
    formatCurrency,
    isLoading,
  }
